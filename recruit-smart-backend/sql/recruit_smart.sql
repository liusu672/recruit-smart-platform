...
CREATE TABLE `ai_match_result`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'AI简历匹配结果ID',
  `task_id` bigint NULL DEFAULT NULL COMMENT 'AI任务ID',
  `application_id` bigint NULL DEFAULT NULL COMMENT '投递记录ID',
  `job_id` bigint NULL DEFAULT NULL COMMENT '岗位ID',
  `candidate_id` bigint NULL DEFAULT NULL COMMENT '候选人ID',
  `resume_id` bigint NULL DEFAULT NULL COMMENT '简历ID',
  `score` int NULL DEFAULT NULL COMMENT '匹配分数，0-100',
  `level` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '推荐等级：LOW/MEDIUM/HIGH',
  `summary` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '匹配摘要',
  ...
  INDEX `idx_ai_match_application_id`(`application_id` ASC) USING BTREE,
  INDEX `idx_ai_match_job_id`(`job_id` ASC) USING BTREE,
  INDEX `idx_ai_match_candidate_id`(`candidate_id` ASC) USING BTREE,
  INDEX `idx_ai_match_resume_id`(`resume_id` ASC) USING BTREE,
  INDEX `idx_ai_match_score`(`score` ASC) USING BTREE,
  INDEX `idx_ai_match_level`(`level` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'AI简历匹配结果表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `application_process_event`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '流程事件ID',
  `application_id` bigint NOT NULL COMMENT '投递记录ID',
  `event_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '事件类型编码',
  `from_status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '操作前状态',
  `to_status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '操作后状态',
  `title` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '事件标题',
  `description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '事件说明或操作备注',
  `operator_id` bigint NULL DEFAULT NULL COMMENT '操作人用户ID，系统事件可为空',
  `operator_role` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '操作时的角色编码',
  `source_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'BUSINESS' COMMENT '来源：BUSINESS、AI、SYSTEM',
  `related_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '关联对象类型',
  `related_id` bigint NULL DEFAULT NULL COMMENT '关联对象ID',
  `occurred_at` datetime NOT NULL COMMENT '事件发生时间',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '记录创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_event_application_time`(`application_id` ASC, `occurred_at` ASC, `id` ASC) USING BTREE,
  INDEX `idx_event_operator_id`(`operator_id` ASC) USING BTREE,
  INDEX `idx_event_type`(`event_type` ASC) USING BTREE,
  INDEX `idx_event_related`(`related_type` ASC, `related_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '招聘流程事件记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `employee_profile`  (
  ...
  `risk_assessed_at` datetime NULL DEFAULT NULL COMMENT '最近一次离职风险评估时间',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `interview`  (
  ...
  `round` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'FIRST' COMMENT '面试轮次：FIRST一面，SECOND二面，HR表示HR面',
  `interview_time` datetime NULL DEFAULT NULL COMMENT '面试官确认的面试时间，待预约时为空',
  `method` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '面试方式：ONLINE线上，OFFLINE线下，PHONE电话',
  `location` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '面试地点或会议链接',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ASSIGNED' COMMENT '状态：ASSIGNED待预约，SCHEDULED待面试，COMPLETED已完成，CANCELED已取消，REINTERVIEW为旧版复试状态',
  `created_by` bigint NOT NULL COMMENT '创建人用户ID',
  `assigned_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'HR指派时间',
  `scheduled_at` datetime NULL DEFAULT NULL COMMENT '面试官确认预约时间',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `interview_feedback`  (
  ...
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_feedback_interview_id`(`interview_id` ASC) USING BTREE,
...
CREATE TABLE `message_conversation`  (
  ...
  `last_message_preview` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '最后一条消息摘要',
  `last_message_at` datetime NULL DEFAULT NULL COMMENT '最后一条消息时间',
  `created_by` bigint NULL DEFAULT NULL COMMENT '会话创建人用户ID，系统自动创建时为空',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '招聘流程消息会话表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `message_conversation_member`  (
  ...
  `role_code` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '加入会话时的角色编码',
  `last_read_at` datetime NULL DEFAULT NULL COMMENT '最后已读时间',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '消息会话成员表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `message_record`  (
  ...
  `conversation_id` bigint NOT NULL COMMENT '会话ID',
  `sender_id` bigint NULL DEFAULT NULL COMMENT '发送人用户ID，系统消息为空',
  `sender_role` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '发送人角色编码',
  `message_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'TEXT' COMMENT '消息类型：TEXT文本，SYSTEM系统通知，FILE附件',
  `content` varchar(5000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '消息正文',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '站内消息记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `resume`  (
  ...
  `parse_status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDING' COMMENT '解析状态：PENDING等待解析，PROCESSING解析中，SUCCESS解析成功，FAILED解析失败',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_resume_candidate_id`(`candidate_id` ASC) USING BTREE,
  INDEX `idx_resume_is_default`(`is_default` ASC) USING BTREE,
  INDEX `idx_resume_parse_status`(`parse_status` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '简历表' ROW_FORMAT = Dynamic;
